...
import static com.brunodles.ginq_cli.ExtensionFunctions.first
import static com.brunodles.ginq_cli.ExtensionFunctions.registerCustomExtensionFunctions
import static com.brunodles.ginq_cli.ExtensionFunctions.tryOrNull

class GroovyInterpreter {

    private static String DEFAULT_IMPORTS = """""".stripIndent()
